...
<head>
    ...
    <title>Categorías - Tienda MS</title>
...
.logo h2 {
    ...
    color: transparent;                 /* ← fallback */
        ...
        .categorias-list h2 i { color: var(--primary); }
        ...
        .btn-editar { color: #60a5fa; }
        .btn-editar:hover { background: rgba(59, 130, 246, 0.1); transform: scale(1.1); }
        .btn-eliminar { color: #f87171; }
        .btn-eliminar:hover:not(.disabled) { background: rgba(239, 68, 68, 0.1); transform: scale(1.1); }
        ...
        @media (max-width: 768px) {
            ...
            .categorias-table { min-width: 500px; }
            .modal-content { padding: 20px; }
            .form-container, .categorias-list { padding: 18px; }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav>
            ...
            <div class="nav-section">
                ...
                <a href="categorias.php" class="nav-item active"><i class="fa-solid fa-layer-group"></i> Categorías</a>
    ...
    <div class="main-content">
        <div class="header">
            <h1><i class="fa-solid fa-folder-tree"></i> Categorías</h1>
        ...
        <div class="form-container">
            <h2><i class="fa-solid fa-plus"></i> Agregar Nueva Categoría</h2>
            <form method="POST">
                <div class="form-group">
                    <label for="nombre">Nombre de la categoría *</label>
                    <input type="text" id="nombre" name="nombre" required placeholder="Ej: Hombre, Mujer, Deportivos...">
                </div>
                
                <div class="form-group">
                    <label for="descripcion">Descripción (opcional)</label>
                    <textarea id="descripcion" name="descripcion" rows="3" placeholder="Describe brevemente esta categoría..."></textarea>
                </div>
        ...
        <div class="categorias-list">
            <h2><i class="fa-solid fa-list"></i> Categorías Existentes</h2>
                    ...
                    <table class="categorias-table">
                        ...
                        <tbody>
                            <?php while($row = $categorias->fetch_assoc()): 
                                $count = $conn->query("SELECT COUNT(*) as total FROM productos WHERE categoria_id = " . $row['id']);
                                $total_productos = $count->fetch_assoc()['total'];
                            ?>
                                <tr>
                                    <td>#<?php echo $row['id']; ?></td>
                                    <td><strong><?php echo htmlspecialchars($row['nombre']); ?></strong></td>
                                    <td>
                                        <?php echo $row['descripcion'] ? htmlspecialchars($row['descripcion']) : '<em style="color:var(--text-muted);">Sin descripción</em>'; ?>
                                    </td>
                                    <td>
                                        <?php if ($row['activo']): ?>
                                    ...
                                    <td><span class="productos-count"><?php echo $total_productos; ?> productos</span></td>
                                    <td class="acciones">
                                        <button onclick="editarCategoria(<?php echo $row['id']; ?>)" class="btn-editar" title="Editar">
                                        ...
                                        <?php else: ?>
                                            <button class="btn-eliminar disabled" disabled title="No se puede eliminar: hay productos usando esta categoría">
                                                <i class="fa-solid fa-trash"></i>
                                            </button>
                                        <?php endif; ?>
                                    </td>
    ...
    <div id="editarModal" class="modal">
        <div class="modal-content">
            ...
            <h2><i class="fa-solid fa-pen"></i> Editar Categoría</h2>
            ...
            <form method="POST" id="editarForm">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="activo" id="edit_activo" checked>
                        Categoría activa
                    </label>
                </div>
